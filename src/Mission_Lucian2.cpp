...
int main(int argc, char **argv)
{
    ...
    while (drone.Data.lidar.ranges[3] == INFINITY && drone.Data.lidar.ranges[4] == INFINITY && drone.Data.lidar.ranges[5] == INFINITY && drone.Data.lidar.ranges[1] > 0.2)
    {
    ...
    if (drone.Data.lidar.ranges[1] <= 0.2)
    {
        Count = 0;
