...
#include <iostream>
/*
void move(double fwd, double lat,GDPdrone &drone)
{
    for(int j = 0; j < 10; j++) {
        drone.Commands.move_Position_Local(lat, fwd, 0, 0, "BODY_OFFSET", j);
        ros::spinOnce();
        rate.sleep();
    }
}

void movei(int fwd, int lat,GDPdrone &drone)
{
    for(int j = 0; j < 10; j++) {
        drone.Commands.move_Position_Local(lat, fwd, 0, 0, "BODY_OFFSET", j);
        ros::spinOnce();
...
void initialize(int argc, char **argv, GDPdrone &drone)
{
            ...
            //std::cout << v.x << " " << v.y << '\n';
                    ...
                    for(int j = 0; j < 10; j++) {
                        ...
                        rate.sleep();
                                ...
                                yst+=3;
                for(int j = 0; j < 10; j++) {
                    drone.Commands.move_Position_Local((-3), 0, 0, 0, "BODY_OFFSET", j);
                    ros::spinOnce();
                    rate.sleep();
                }
